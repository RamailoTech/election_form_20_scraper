...
logging.basicConfig(filename='logs/karnatakata_AE_2023_filtered_pdfs_parse_logs.txt', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
directory_path = "data/PDFs/Rajasthan/2023_filtered"


# Specify the folder path to save JSON files
output_folder = "results/Parsed_Pdfs/KA_filtered/2023"
...
for filename in os.listdir(directory_path):
    if filename.endswith(".pdf"):  # Check if the file is a PDF
        ...
        try:
            ...
            output_filename = f"JSON_karnataka_AssemblyElection_2023_{os.path.splitext(filename)[0]}.json"
